...
# Scored execution uses the deterministic competition workflow. This documented
# official gate is read when RobotAgent constructs AgentConfig after importing
# this module.
