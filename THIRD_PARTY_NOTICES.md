...
核对日期：2026-07-28。本文件是工程合规记录，不替代正式法律意见。任何组件进入最终提交前都必须再次核对固定版本的许可证全文、依赖链、模型权重和数据条款。

## 官方基线

| 组件 | 用途 | 来源 | 固定版本 | 状态 |
|---|---|---|---|---|
| JCIIOT2026 | 官方环境、评分器和基线 | <https://github.com/JCIIOT2026/JCIIOT2026> | `0dcdddf18a9e694569aa1433cdfc04eb097fed78` | 必须保留来源；只在官方允许目录内提交改动 |
